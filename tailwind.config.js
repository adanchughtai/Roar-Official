  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glow-red': '0 4px 20px rgba(225, 6, 0, 0.35)',
        'glow-red-lg': '0 8px 40px rgba(225, 6, 0, 0.5)',
        'premium': '0 20px 40px rgba(0, 0, 0, 0.15)',
        'premium-dark': '0 20px 40px rgba(225, 6, 0, 0.1)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 4px 20px rgba(225, 6, 0, 0.35)" },
          "50%": { boxShadow: "0 8px 40px rgba(225, 6, 0, 0.6)" },
        },
        "shimmer": {
